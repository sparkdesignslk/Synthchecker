export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `You are an expert forensic image analyst. Analyze this image for signs of AI generation. Respond ONLY with a raw JSON object, no markdown fences, no extra text, exactly this shape:
